CONVERSATION_SUMMARY_PROMPT = """You are an expert conversation summarizer.
...
QUERY_ANALYSIS_PROMPT = """You are an expert query analyst and rewriter.
...
RAG_AGENT_PROMPT = """You are an expert retrieval-augmented assistant.
...
AGGREGATION_PROMPT = """You are an expert aggregation assistant.
